...
public class RoleRequest implements Comparable<RoleRequest> {
	...
	*/
	@Override
	public int compareTo(RoleRequest o) {
	 ...
	 * @param label
	 */
	public RoleRequest(String label) {
		super();
		this.label = label;
	}
	 ...
	 * @param label
	 */
	public RoleRequest(int idRole, String label) {
		super();
		this.idRole = idRole;
		this.label = label;
	}
