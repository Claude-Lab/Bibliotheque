...
<%@ include file="public/includes/header.html"%>
<body id="page-top">

	<!-- Navigation -->
	<%@ include file="public/includes/nav.html"%>

	<!-- Page Header -->
	<%@ include file="public/includes/pageheader.html"%>
				...
				<div class="col-lg-8 mx-auto">
					...
					<div class="row">
						<div class="col-lg-12 col-md-10 mx-auto">
							<a class="btn btn-primary btn-lg btn-block" href="app/public/connexion"
					...
					<div class="row">
						<div class="col-lg-12 col-md-10 mx-auto">
							<a class="btn btn-secondary btn-lg btn-block" href="app/public/inscription"
	...
	<%@include file="public/includes/footer.html"%>