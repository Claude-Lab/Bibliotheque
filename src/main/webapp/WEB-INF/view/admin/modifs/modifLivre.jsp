	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<!-- Page Heading -->
				<h1 class="h3 mb-2 text-gray-800">${livre.titre}</h1>
				<p class="mb-4"></p>
				...
				<div class="card shadow mb-4">
					...
					<div class="card mb-4">
						<div class="card-header py-3">
							<h6 class="m-2 font-weight-bold text-primary">Modifier le livre "${livre.titre}"</h6>
						</div>
						<div class="card-body">


							<form:form action="modifierLivreValid" method="POST" cssClass="form-horizontal" modelAttribute="livre">
								<form:hidden path="idLivre" />

								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<form:label path="titre"> Titre : </form:label>
										<form:input path="titre" type="text"  class="form-control form-control-user" placeholder="Nom" required="required"></form:input>
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										...
										<form:input path="isbn" type="text"  title="chiffre et signe spéciaux interdit" class="form-control form-control-user" placeholder="Prénom" required="required"></form:input>
