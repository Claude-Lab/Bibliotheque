				...
				<div class="card shadow mb-4">
					...
					<div class="card mb-4">
						<div class="card-header py-3">
							<h6 class="m-2 font-weight-bold text-primary">Modifier un auteur</h6>
						</div>
						<div class="card-body">


							<form:form action="modifierAuteurValid" method="POST" cssClass="form-horizontal" modelAttribute="auteur">
								<form:hidden path="idAuteur" />
								...
								<a href="gestionAuteurs" class="btn btn-secondary" role="button" aria-pressed="true">ANNULER</a>
