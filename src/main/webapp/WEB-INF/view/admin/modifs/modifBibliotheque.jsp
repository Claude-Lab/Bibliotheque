	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				...
				<!-- Page Heading -->
				<h1 class="h3 mb-2 text-gray-800">${bibliotheque.nom}</h1>
				<p class="mb-4"></p>
				...
				<div class="card shadow mb-4">
					...
					<div class="card mb-4">
						<div class="card-header py-3">
							<h6 class="m-2 font-weight-bold text-primary">Modifier les informations de la ${bibliotheque.nom}</h6>
						</div>
						<div class="card-body">


							<form:form action="modifierBibliothequeValid" method="POST" cssClass="form-horizontal" modelAttribute="bibliotheque">
								<form:hidden path="idBibliotheque" />
								...
								<a href="gestionBibliotheques" class="btn btn-secondary" role="button" aria-pressed="true">ANNULER</a>
