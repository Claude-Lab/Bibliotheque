				...
				<div class="card shadow mb-4">
					...
					<div class="card mb-4">
						<div class="card-header py-3">
							<h6 class="m-2 font-weight-bold text-primary">Ajouter une personne</h6>
						</div>
						<div class="card-body">
							...
							<form:form action="validPersonne" method="POST" cssClass="form-horizontal" modelAttribute="pers" >
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										...
										<form:input path="password" type="password" pattern="[-[:alpha:]]{8,10}" title="chiffre et signe spéciaux interdit" class="form-control form-control-user" placeholder="Mot de passe"
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										...
										<form:input path="confirmPassword" type="password" pattern="[-[:alpha:]]{8,10}" title="chiffre et signe spéciaux interdit" class="form-control form-control-user"
