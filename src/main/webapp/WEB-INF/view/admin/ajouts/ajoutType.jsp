							...
							<form:form action="validType" method="POST" cssClass="form-horizontal" modelAttribute="type">
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<form:label path="libelle"> Indiquez le nouveau type : </form:label>
										<form:input path="libelle" type="text" pattern="[0-9]{5}" class="form-control form-control-user" placeholder="libelle"></form:input>
