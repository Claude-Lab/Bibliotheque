				...
				<div class="card shadow mb-4">
					...
					<div class="card mb-4">
						<div class="card-header py-3">
							<h6 class="m-2 font-weight-bold text-primary">Ajouter un éditeur</h6>
						</div>
						<div class="card-body">


							<form:form action="validEditeur" method="POST" cssClass="form-horizontal" modelAttribute="editeur" >
								...
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
										<form:label path="coordonnee.pays"> Pays : </form:label>
										<form:input path="coordonnee.pays" type="text" pattern="[a-zA-Z ]{2,25}" title="Pas de chiffre" class="form-control form-control-user" placeholder="Pays"></form:input>
										<form:errors path="coordonnee.pays" cssClass="erreur"></form:errors>
									</div>
								</div>
								<div class="form-group row">
									<div class="col-sm-6 mb-3 mb-sm-0">
								...
								<a href="gestionPersonnes" class="btn btn-secondary" role="button" aria-pressed="true">ANNULER</a> <br>
