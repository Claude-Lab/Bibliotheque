	...
	<div id="content-wrapper" class="d-flex flex-column">
		...
		<div id="content">
			...
			<div class="container-fluid">
				<a href="javascript:history.go(-1)" class="btn btn-success" role="button" aria-pressed="true">Retour</a> <br>
				<br>
				<!-- Page Heading -->
				...
				<div class="card shadow mb-10">
					...
					<a href="#collapseCard1" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCard1">
						<h6 class="m-1 font-weight-bold text-primary">Detail du compte client</h6>
					</a>
